    ...
    static tasks = [
        {
            ...
            description: 'In this task we observed how Hawaiian residents and consumers find, study, and select a health insurance plan for themselves (and family, if applicable), starting on HMSA.com.',
        ...
        },
        {
            ...
            description: 'In this task we observed how Hawaiian residents and consumers locate information on hmsa.com about the gym or fitness benefits included with their health insurance plan.',
            ...
            firstInteraction: {
                ...
                interaction: 'Started with Google search. Clicked one of top 3 organic search results - either the PDF result, "Fitness membership - HMSA.com" or the link "Active&Fit® Program - HMSA.com"'
            },
            issues: [
                {
        ...
        },
        {
            ...
            description: 'In this task we observed how Hawaiian residents and consumers search for a doctor who is covered under their HMSA health insurance plan.',
            ...
            firstInteraction: {
                ...
                interaction: 'Started on hmsa.com. Clicked "Find a Doctor" in main (top) navigation.'
            },
            issues: [
                {
                    participants: ['male'],
        ...
        },
        {
            ...
            description: 'In this task we observed how Hawaiian residents and consumers find, study, and select a health insurance plan for themselves (and family, if applicable) - starting on kpinhawaii.com.',
            url: 'kp-path-to-app',
            completionRate: 8,
            completionBreakdown: [
                {label: 'Success', score: 3},
            ...
            firstInteraction: {
                ...
                interaction: 'Started by clicking on "Shop Our Plans" in main (top) navigation)'
            },
            issues: [
                {
        ...
        },
        {
            ...
            firstInteraction: {
                participants: ['male','female','male'],
                interaction: 'All started with a Google search. Two clicked one of the top 2 organic search results; one looked at what was saved in her browser history.'
            },
            issues: [
                {
                    participants: ['male'],
        ...
        },
        {
            ...
            description: 'In this task we observed how Hawaiian residents and consumers search for a doctor who is covered under their Kaiser Permanente health insurance plan.',
            url: 'kp-find-doctor',
            completionRate: 0,
            completionBreakdown: [
                {label: 'Success', score: 0},
