  ...
  <div>
    ...
    <Expandable number='1'>
      ...
      <div className="expandable-content">
        <p>The majority of the participants were overwhelmed by the number of plans and options from both HMSA.com and kpinhawaii.com. They left both sites without applying, opting instead to call someone in customer service, or solicit recommendations from friends or family.</p>
        <ul>
          ...
          <li>Often, the proximity of good quality health care providers (doctors, clinics, hospitals) to their home and work will affect what plan they choose (HMSA vs. Kaiser Permanente).</li>
        </ul>
    ...
    <Expandable number='2'>
      <h3>HMSA.com pages and content need to empower consumers to focus and scan</h3>
      <div className="expandable-content">
        ...
        <p>To that end, the content, layout, and call-to-action on every HMSA.com page needs to simple, obvious, and direct. That way, the consumer’s first click or interaction with the site will be the right interaction (path) to get them to application/enrollment, or find a healthcare provider, or get information. Site imagery, icons, and multimedia should meet, or exceed, their expectations of simplicity, clarity, and brevity.</p>
      </div>
    </Expandable>
    <Expandable number='3'>
      <h3>Somebody should always be online to help me</h3>
      <div className="expandable-content">
        <p>Many of the participants abandoned HMSA.com and kpinhawaii.com to call a customer service number they found while evaluating health insurance plans. We did not test the telephone support experience, but there is a risk the consumer will delay calling, forget to call, or give up if they have to wait a long time to talk to someone.</p>
    ...
    <Expandable number='4'>
      <h3>Allow consumers to compare HMSA plans to other insurers (Kaiser Permanente, etc.)</h3>
      <div className="expandable-content">
        ...
        <p>A few of the 65+ participants on day 2 stated the ability to compare across all health insurers as one idea to make the HMSA.com path-to-application/enrollment better (easier, faster, and more empowering).</p>
    ...
    <Expandable number='5'>
      ...
      <div className="expandable-content">
        <p>All consumers struggled to explain the benefits and options included with any health insurance plans on either HMSA.com or kpinhawaii.com. The language of health insurance was hard to understand and was too often interpreted incorrectly.</p>
        <p>Example: Several consumer participants wrongly interpreted “maximum out-of-pocket” as the maximum amount that HMSA or Kaiser Permanente would pay out for their healthcare costs in a single year. This caused them to think no plan had enough coverage.</p>
        <p>Making the language of health insurance plain-spoken English is an immense opportunity to differentiate HMSA.com and their path-to-application/enrollment from Kaiser Permanente.</p>
        <p>In addition, the consumer participants we studied were overwhelmed with the information in the HMSA summary of benefits PDF. Most clicked the link to that from the Compare Plans page but quickly left that PDF as it would take too much time to read and digest.</p>
    ...
    <Expandable number='8'>
      <h3>Consumers want to trust that the information they share on HMSA.com or kpinhawaii.com is secure and they are safe from identity theft</h3>
      <div className="expandable-content">
        ...
        <p>One recommendation was to allow consumers to see plans and prices, and then ask for information. It may help to make the reason why specific information is requested and what the user will gain by giving HMSA that information. Will it shorten the application/enrollment and approval processes?</p>
      </div>
    </Expandable>
    <Expandable number='9'>
      ...
      <div className="expandable-content">
        ...
        <p>Making HMSA.com content plain-spoken, easy to scan, and getting the user on the right path will empower consumers to make decisions they are confident are right for themselves and their households.</p>
      </div>
    </Expandable>
